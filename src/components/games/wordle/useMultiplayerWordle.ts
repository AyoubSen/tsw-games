...
import type { ServerMessage, PublicGameState, GameMode } from "../../../../party/wordle"
...
export interface MultiplayerState {
  ...
  error: string | null
  isHost: boolean
  waitingFor: string[] // Players we're waiting for in turns mode
...
export function useMultiplayerWordle() {
  ...
  const joinGame = useCallback((roomCode: string, playerName: string) => {
    connect(roomCode.toUpperCase(), false, "race", playerName) // Mode doesn't matter for joining
  }, [connect])
